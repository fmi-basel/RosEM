...
class MonitorJob(QObject):
    ...
    def __init__(self, parent, job_params):
        ...
        self.log_file = self.job_params['log_file']
        self.log_file = self._parent.job.get_log_file(self.job_params['project_path'], self.job_params['job_project_id'], self.job_params['job_name'])
    ...
    def run(self) -> None:
        ...
        thread_info = f"JobID: {self.job_params['job_project_id']}"
...
class RunProcessThread(QObject):
    ...
    def __init__(self, parent, job_params, cmd):
        ...
        self.job_params = copy.deepcopy(job_params)
        self.cmd = cmd
        self.log_file = job_params['log_file']
    ...
    def run(self):
        ...
        try:
            ...
            if self.job_params['queue']:
                with Popen(cmd, preexec_fn=os.setsid, stdout=PIPE, stderr=PIPE) as p:
                    cpid = p.pid
